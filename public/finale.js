// Data & Initialization
const winnerssssssss1 = JSON.parse(localStorage.getItem("winnerCsi")); // show the winner in the console
...
document.getElementById("validateNextBtn").addEventListener("click", () => {
  ...
  if (team) {
    ...
    if (winners.length === numberOfWinners) {
      ...
      localStorage.setItem("winnerCsi", JSON.stringify(winners)); // you can delete this, it just pass the winners to another page
